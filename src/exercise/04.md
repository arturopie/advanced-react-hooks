...
* Use useLayoutEffect when you want to run code before is DOM is painted on the screen. For example, if we manipulate the dom via ref, we might need to use useLayoutEffect
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=04%3A%20useLayoutEffect%3A%20auto-scrolling%20textarea&em=arturop%40nulogy.com).
